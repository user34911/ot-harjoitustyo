import pygame
from pygame_gui.elements import UIScrollingContainer, UILabel, UIPanel
...
class Leaderboards:
    ...
    def recreate(self, manager):
        ...
        self.container = UIScrollingContainer(pygame.Rect(50, 50, self._window_size[0] - 100, self._window_size[1] - 100),
                                                       manager=manager,
                                                       visible=False,
